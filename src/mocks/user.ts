...
function randomProductsAndPortions() {
  ...
  return produtosMercadinho.slice(sliceStart, sliceEnd).map(p => {
    return {
      amount: portion(),
      offer: p.offer,
    };
